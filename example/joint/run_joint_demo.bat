...
@echo Smooth  points
Quality.exe -I joint_hex_initial_lap_pillow.vtk --method 2 --parameter 0.001 --number 1  
@echo Done!
@echo -------------------------------------------------------------------
@pause

@echo Optimize element with minimum Jacobian Method 3 ran about 4 times
Quality.exe -I joint_hex_initial_lap_pillow_smooth.vtk   --method 3 --parameter 0.01 --number  50
@echo Done!
@echo -------------------------------------------------------------------
@pause
